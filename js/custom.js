(function () {
	...
	var contentWayPoint = function () {
		var i = 0;
		jQuery('.bertha-animate').waypoint(function (direction) {

			if (direction === 'down' && !jQuery(this.element).hasClass('bertha-animated')) {
				...
				setTimeout(function () {
					...
					jQuery('body .bertha-animate.item-animate').each(function (k) {
						var el = jQuery(this);
						setTimeout(function () {
							var effect = el.data('animate-effect');
							if (effect === 'fadeIn') {
								el.addClass('fadeIn bertha-animated');
							} else if (effect === 'fadeInLeft') {
								el.addClass('fadeInLeft bertha-animated');
							} else if (effect === 'fadeInRight') {
								el.addClass('fadeInRight bertha-animated');
							} else {
								el.addClass('fadeInUp bertha-animated');
							}
	...
	var navbarState = function () {
		...
		jQuery(window).scroll(function () {
			...
			if (st > 5) {
				jQuery('.bertha-navbar').addClass('scrolled');
			} else {
				jQuery('.bertha-navbar').removeClass('scrolled');
			}
	...
	jQuery(function () {
		contentWayPoint();
		navbarState();
		if (jQuery('.bertha-gallery').length > 0) {
			initPhotoSwipeFromDOM('.bertha-gallery');
		}
		galleryMasonry();
		stellarInit();
		dateTimePicker();
	...
	var popupLink = $('.md-trigger');
	var popupModal = $('.md-modal');
	var overlay = $('.md-overlay');
	popupLink.on('click', function (e) {
		e.preventDefault();
		var currentImg = $(this).find('img').attr('data-src');
		popupModal.find('.md-img').attr('src', currentImg);
